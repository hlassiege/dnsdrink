<template>
    <main class="min-h-screen bg-gray-100 flex flex-col items-center justify-center ">
        ...
        <div class="text-left text-lg mb-6 text-slate-700">
            <span class="font-bold text-slate-600">One rule:</span> try to create a brand name that is not a domain name. <br>
                    ...
                    <div class="flex">
                        ...
                        <div class="ms-3">
                            ...
                            <div class="mt-2 text-sm text-gray-600 dark:text-neutral-400">
                                This domain is already registered. <strong>Drink up!</strong>
                            </div>
                        </div>
                    </div>
                </div>
